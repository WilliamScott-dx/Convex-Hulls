"""
Graham-scan Algorithm Evaluator
...
def tester(size=1000, shape="square"):
    ...
    test_result = "Grahamscan {0!s} with {1!s} points: Averaged {2!s}s over 5 trials.".format(shape, size, average_time)
    print(test_result)
